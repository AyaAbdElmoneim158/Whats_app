...
import '../../../data/models/status_image_model.dart';
import '../../../data/models/status_model.dart';

class StatusPage extends StatefulWidget {
  final StatusModel currentUser;
...
class _StatusPageState extends State<StatusPage> {
  List<StatusImageModel> _stories = [];
  ...
  Future _fillMyStoriesList(StatusEntity status) async {
    if (status.stories != null) {
      ...
      for (StatusImageModel story in status.stories!) {
  ...
  _bodyWidget(List<StatusEntity> statuses, StatusModel currentUser,
        ...
        children: [
          ...
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                for (StatusImageModel storyItem in status.stories!) {
  ...
  _uploadImageStatus(StatusModel currentUser) {
  ...
  void _eitherShowOrUploadSheet(
      StatusEntity? myStatus, StatusModel currentUser) {
    if (myStatus != null) {
      _showStatusImageViewBottomModalSheet(
