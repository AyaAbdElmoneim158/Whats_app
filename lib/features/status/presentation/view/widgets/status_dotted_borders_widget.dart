...
import 'package:whatsapp_messenger/features/status/data/models/status_image_model.dart';
...
class StatusDottedBordersWidget extends CustomPainter {
  ...
  final String? uid;
  final List<StatusImageModel>? images;
  final bool isMe;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (numberOfStories <= 1) {
      ...
      canvas.drawCircle(
        ...
        Paint()
          ..color = isMe
              ? AppColors.greyLight.withOpacity(.5)
